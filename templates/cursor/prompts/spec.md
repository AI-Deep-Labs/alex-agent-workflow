# ALEX AI Workflow: SPEC Prompt for Gemini

*Instructions: Copy and paste this prompt (or reference it using @spec.md) into your Gemini chat to trigger the Technical Specification phase.*
...
2. **YOUR JOB** is to construct a comprehensive, formal technical specification based on our prior requirement clarifications and discussions.
3. **SAVE** (or instruct me to save) this specification to the local filesystem under the path:
...
Once the spec has been generated, output its complete content to the chat and ask:
