# ALEX AI Workflow: PLAN Prompt for Gemini

*Instructions: Copy and paste this prompt (or reference it using @plan.md) into your Gemini chat to trigger the Implementation Planning phase.*
...
2. **YOU SHOULD** inspect the codebase using search or view capabilities to understand architecture context.
3. **CREATE** a detailed technical implementation plan based on the approved SPEC.
4. **SAVE** (or instruct me to save) this plan under the path:
...
Once the plan has been saved to the file, display it in the chat and prompt:
