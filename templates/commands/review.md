...
1. **DO NOT** modify any source code unless the user explicitly requests a fix.
...
After displaying this report, ask the user if they would like you to fix any of the highlighted issues.
