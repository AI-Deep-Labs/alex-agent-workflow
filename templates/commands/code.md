...
7. **RUN** build and test commands (e.g. `npm test`, `dotnet test`, etc.) immediately after implementing to verify correctness.
8. **IF THE PLAN DEVIATES** during implementation, stop and explain the technical reason to the user.
